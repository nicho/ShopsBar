...
<link href="${ctx}/static/bootstrap/2.2.2/css/bootstrap-responsive.min.css" type="text/css" rel="stylesheet" />
...
<link href="${ctx}/static/styles/indexPage.css" type="text/css" rel="stylesheet" />
